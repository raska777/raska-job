...
//   try {
//     const { id } = params;  // params.id ni olish
...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    // _id maydonini ishlatmasdan olish
    const { _id: _, ...updateData } = body;  // Bu yerda _id ni _ deb nomlab, ishlatilmayotganini bildiramiz
