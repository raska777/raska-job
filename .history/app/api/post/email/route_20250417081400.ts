...
export async function POST(request: NextRequest) {
  ...
  <p><strong>Platformada yangi ish e’loni joylandi:</strong></p>

  <ul>
    <li>📌 <strong>Ish turi:</strong> ${job.work_type}</li>
    <li>📍 <strong>Joylashuv:</strong> ${job.location}</li>
    <li>🕒 <strong>Ish vaqti:</strong> ${job.work_time}</li>
  </ul>
