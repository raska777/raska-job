...
//       { $set: { ...newSubscriber, subscribedAt: new Date() } },
//       { upsert: true }
//     );
...
//       newSubscriber.email,
//       "✅ Raska Jobga obuna bo'lganingiz uchun rahmat!",
//       `Hurmatli ${newSubscriber.name || 'foydalanuvchi'},\n\nRaska Jobga obuna bo'lganingiz uchun tashakkur.`
//     );

//     if (!emailResult.success) {
//       console.error("Email yuborishda xato:", emailResult.error);
//       throw new Error("Email yuborish muvaffaqiyatsiz tugadi");
//     }

//     return NextResponse.json(
//       { success: true, message: "Obuna tasdiqlandi", messageId: emailResult.messageId },
//       { status: 200 }
//     );
//   } catch (error) {
