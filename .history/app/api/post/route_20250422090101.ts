...
//       const subject = `✨ Siz uchun yangi ish e'loni: ${newJob.work_type} - Raska`;
//             const html = `
...
`;
      ...
      // Tekis matn versiyasi
      const text = `Assalomu alaykum ${user.name || ''},\n\nPlatformada yangi ish e'loni joylandi:\n\nIsh turi: ${newJob.work_type}\nJoylashuv: ${newJob.location}\nViza turi: ${newJob.visa_type}\n\nBatafsil: https://raska-job.vercel.app\n\nHurmat bilan,\nRaska Platformasi jamoasi`;
