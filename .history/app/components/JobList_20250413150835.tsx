...
import { useEffect, useState } from 'react';
import "styles/global.css";
import { useRouter } from 'next/navigation'; // Next.js navigatsiyasi uchun
...
const JobList = ({ 
  ...
  // ... fetchJobs funksiyasi va useEffect o'zgarishsiz qoldi

  return (
    <div className="container mx-auto px-4 py-6">
      {/* Natijalar va Orqaga tugmasi */}
      <div className="flex justify-between items-center mb-6">
        ...
        {(selectedCity || searchQuery) && (
          <button
            onClick={() => {
              if (onResetSearch) {
                onResetSearch(); // Agar prop berilgan bo'lsa
              } else {
