...
//     router.push(`/search?${query.toString()}`); // /search yo'nalishiga o'tkazamiz
//   };
//   return (
...
//         ) : (
//           <>
//             <Link href="/login" className="text-gray-700 hover:underline">Kirish</Link>
//             <Link href="/register" className="text-gray-700 hover:underline">Ro‘yxatdan o‘tish</Link>
//           </>
//         )}
//       </div>
//     </nav>
