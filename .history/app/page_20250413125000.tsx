    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <section className="mb-12 text-center animate-fade-in">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">
          ...
          {/* Search Bar */}
          <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md p-2 flex items-center animate-slide-up">
            <input
              type="text"
