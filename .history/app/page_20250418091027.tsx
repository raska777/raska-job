    ...
    <div className="raskajob-container">
      ...
      <header className="raskajob-header">
        ...
        <div className="raskajob-header-content">
          ...
          {/* Search panel */}
          <div class="raskajob-search-container">
  <div class="raskajob-search-box">
    
    <!-- All Cities (select) yuqorida) -->
    <select className="raskajob-search-select">
    ...
    <input
      type="text"
      class="raskajob-search-input"
      placeholder="Search for jobs..."
    />

    <button class="raskajob-search-button">
      Search
    </button>
