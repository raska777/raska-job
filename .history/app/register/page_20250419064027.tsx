...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!form.email.trim()) {
      ...
      newErrors.email = 'Noto&apos;g&apos;ri email formati';  // Updated here
      valid = false;
    }
    ...
    if (!form.password) {
      ...
      newErrors.password = 'Parol kamida 6 belgidan iborat bo&apos;lishi kerak';  // Updated here
      valid = false;
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        alert('Ro&apos;yxatdan o&apos;tildi!');  // Updated here
        router.push('/login');
      } else {
        alert(data.error || 'Xatolik yuz berdi');
      }
  ...
  return (
    <main className={styles.container}>
      <h1 className={styles.title}>Ro&lsquo;yxatdan o‘tish</h1>  {/* Updated here */}
      <form onSubmit={handleSubmit} className={styles.form}>
        <div className={styles.inputGroup}>
          <input
            type="text"
        ...
        <div className={styles.inputGroup}>
          <div className={styles.passwordContainer}>
            ...
            <button
              ...
              className={styles.togglePassword}
            >
              {showPassword ? 'Yashirish' : 'Ko&lsquo;rsatish'}  {/* Updated here */}
            </button>
          </div>
          {errors.password && <span className={styles.error}>{errors.password}</span>}
          <div className={styles.strengthMeter}>
        ...
        <button
          ...
          className={styles.submitButton}
        >
          {isLoading ? 'Yuklanmoqda...' : 'Ro&lsquo;yxatdan o‘tish'}  {/* Updated here */}
        </button>
        ...
        <button 
          ...
          className={styles.socialButton}
        >
          Google orqali ro&apos;yxatdan o&apos;tish {/* Updated here */}
        </button>
