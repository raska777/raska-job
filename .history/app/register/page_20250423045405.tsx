...
export default function RegisterPage() {
  ...
  const handleGoogleSignIn = async () => {
      try {
        ...
        setErrors('Google orqali kirishda xatolik');
      } finally {
        setIsLoading(false);
      }
    };
  ...
  return (
    <main className={styles.container}>
      <h1 className={styles.title}>Ro&lsquo;yxatdan o&lsquo;tish</h1>
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <div className={styles.inputGroup}>
          <div className={styles.passwordContainer}>
            ...
            >
              {showPassword ? 'Yashirish' : 'Ko&lsquo;rsatish'}
            </button>
          </div>
        ...
        >
          {isLoading ? 'Yuklanmoqda...' : 'Ro&lsquo;yxatdan o&lsquo;tish'}
        </button>
